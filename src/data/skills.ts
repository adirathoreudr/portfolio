export const marqueeItems = [
  { text: "AWS Certified Solutions Architect", featured: true },
  { text: "Kubernetes", featured: false },
  { text: "Terraform", featured: false },
  { text: "AWS Certified AI Practitioner", featured: true },
  { text: "Next.js", featured: false },
  { text: "TypeScript", featured: false },
  { text: "Solidity", featured: false },
  { text: "Rust", featured: false },
  { text: "LangChain", featured: false },
  { text: "Docker", featured: false },
  { text: "CI/CD", featured: false },
  { text: "Solana", featured: false },
];
